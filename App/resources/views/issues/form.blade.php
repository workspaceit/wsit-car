...
@section('breadcrumbs', Breadcrumbs::render('issues.create'))
...
@section('content')
    ...
    <div class="card" id="app">
        {!! Form::open([ 'route'=>['supports.store'],'method'=>'post','class'=>'form-horizontal', 'enctype'=>"multipart/form-data"]) !!}

        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label">@lang('ui.name')<span
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label">@lang('ui.email')<span
                                    class="text-danger"><sup>*</sup></span></label>
                        <div class="col-md-9">
                            {!! Form::text('email',old('email'),['class'=>$errors->has('email')? 'form-control border-danger':'form-control','placeholder'=>'','title'=>'this is required' ]) !!}
                            @if($errors->has('email'))
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-md-3 col-form-label">@lang('ui.phone number')<span
                                    class="text-danger"><sup>*</sup></span></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row mb-3 dealer-div d-none">
                        <label class="col-md-3 col-form-label">{{trans_choice('ui.dealer', 1)}}<span
                                    class="text-danger"><sup>*</sup></span> <sub><br>
                    ...
                    <div class="form-group row mb-3">
                        <label class="col-lg-3">{{__('ui.description')}}<span class="text-danger"><sup>*</sup></span>
                            <sub><br>
                    ...
                    <div class="form-group row" style="margin-bottom: 8rem;">
                        <label class="col-lg-3">{{trans_choice('ui.photo', 2)}} <sub><br>({{__('ui.attach_photo')}}
                                )</sub></label>
                        <div class="col-lg-9">
                            <div class="form-group-feedback form-group-feedback-right">
